...
import com.angelemv.android.stores.databinding.ItemStoreBinding
...
class StoreAdapter(private var stores: MutableList<StoreEntity>, private  var listener: OnClickListener): RecyclerView.Adapter<StoreAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        with(holder){
            ...
            binding.cbxFavorite.isChecked = store.isfavorite
        }
    }
    ...
    inner class ViewHolder(view: View): RecyclerView.ViewHolder(view){
        ...
        fun setListener(storeEntity: StoreEntity){
            ...
            binding.cbxFavorite.setOnClickListener {listener.onfavoriteStore(storeEntity) }
        }
    }
}